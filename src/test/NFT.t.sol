...
contract TestNFT is NFTTest {
    ...
    function test_metadata_JSON() public {
        ...
        assertEq(
            ...
            '{"name":"Game #1","description":"Tic Tac Token NFT","image":"data:image/svg+xml;base64,"}'
        );
    }
    ...
    function test_encoded_metadata() public {
        assertEq(
            nft.metadataURI(1),
            "data:application/json;base64,"
        );
    }
